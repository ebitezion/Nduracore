...
// EntryRequest retrieves information on a single transaction from a specific ledger version.
...
// EntryResponse represents the response from the transaction_entry method.
