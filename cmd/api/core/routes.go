...
func (app *application) routes() http.Handler {
	...
	routes.Handler(http.MethodPost, "/v1/treasuries", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.createTreasury))))
	routes.Handler(http.MethodGet, "/v1/treasuries", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.listTreasuries))))
	routes.Handler(http.MethodGet, "/v1/treasuries/:id", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.getTreasury))))
	routes.Handler(http.MethodPost, "/v1/treasuries/:id/vaults", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.createVault))))
	routes.Handler(http.MethodGet, "/v1/treasuries/:id/vaults", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.listVaults))))
	routes.Handler(http.MethodGet, "/v1/vaults/:id", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.getVault))))
	routes.Handler(http.MethodPost, "/v1/vaults/:id/assets", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.createVaultAsset))))
	routes.Handler(http.MethodGet, "/v1/vaults/:id/assets", app.authenticate(app.requireRoles("admin", "manager")(http.HandlerFunc(app.listVaultAssets))))
